...
[![Coveralls](https://coveralls.io/repos/github/vikrep/Final-Project/badge.png?branch=masterstyle=flat-square)](https://coveralls.io/github/vikrep/Final-Project?branch=master)
...
$ npm start # start application on localhost:3000
```
## Description

### The final project is a database webpage with a catalog of the collection of CDs and LPs.

### The site structure must have:
1. Welcome page.
2. Search page by catalog and showing the result.
...
1. Header.
2. Main page with the form of input of search of a disk.
3. A table showing the result of the search.
4. The buttons control the display of the number of rows in the table.
5. Footer.

### The structure of the hidden administrator table:
1. Login form and password.
2. Input form for managing database tables (input, modification, deletion).

## The final project site should have:
1. Sorting data in the result table.
2. Show advanced information about the CDs (the number and name of tracks, the time of the track and the photo of the disc covers) when you click on the row in the results table.
3. Link to the homepage of the singer (if present).
4. Responsive design

## The final project site could have:
1. Feedback page
...
2. Additional table, which will have detailed information about each disc (number, title and time of the track, link on the cover photo).
The detailed structure of the tables will be approved later.
